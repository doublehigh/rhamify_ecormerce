...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a class="{{setActive(['user.messages.index'])}}" href="{{route('user.messages.index')}}"><i class="fas fa-comment-dots"></i>Messages</a></li>
      ...
      @if (auth()->user()->role !== 'vendor')
      <li><a class="{{setActive(['user.vendor-request.*'])}}" href="{{route('user.vendor-request.index')}}"><i class="fas fa-store"></i> Be a Vendor</a></li>
      @endif
      <li>
